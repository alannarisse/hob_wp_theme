		...
		<div id="primary" class="showcase">
			<div id="content" role="main">
				...
				<div class="featured-posts">
					<h1 class="showcase-heading"><?php _e( 'Featured Post', 'hob' ); ?></h1>
					...
					<?php
				    	...
				    	while ( $featured->have_posts() ) : $featured->the_post();
							...
							if ( 1 == $counter_slider )
								...
								$class = '';
				    	?>
						<li><a href="#featured-post-<?php echo $counter_slider; ?>" title="<?php printf( esc_attr__( 'Featuring: %s', 'hob' ), the_title_attribute( 'echo=0' ) ); ?>" <?php echo $class; ?>></a></li>
					<?php endwhile;	?>
					</ul>
				</nav>
				...
				<section class="recent-posts">
					<h1 class="showcase-heading"><?php _e( 'Recent Posts', 'hob' ); ?></h1>
					...
					while ( $recent->have_posts() ) : $recent->the_post(); ?>
						...
						<li class="entry-title">
							<a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'hob' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a>
							<span class="comments-link">
								<?php comments_popup_link( '<span class="leave-reply">' . __( 'Leave a reply', 'hob' ) . '</span>', __( '<b>1</b> Reply', 'hob' ), __( '<b>%</b> Replies', 'hob' ) ); ?>
							</span>
						</li>
